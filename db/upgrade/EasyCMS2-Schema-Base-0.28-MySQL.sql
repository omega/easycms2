...
-- Created on Mon Sep 10 20:06:20 2007
-- 
...
CREATE TABLE page_tag (
  ...
  CONSTRAINT page_tag_fk_page FOREIGN KEY (page) REFERENCES page (id) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT page_tag_fk_tag FOREIGN KEY (tag) REFERENCES tag (id) ON DELETE CASCADE ON UPDATE CASCADE
) Type=InnoDB;
