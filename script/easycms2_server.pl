...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{EASYCMS2_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{EASYCMS2_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
easycms2_server.pl - Catalyst Testserver

=head1 SYNOPSIS

easycms2_server.pl [options]
